...
11. **프로젝트 설정/보드/팀 구성** 창의 맨 위에 있는 영역** 탭을 **선택합니다. 팀 이름과 일치하는 이름이 있는 자동으로 생성된 영역이 있습니다.
...
10. 추가 링크를** 클릭하여 **자식 항목을 저장합니다. (새 기능) **학습 대시보드** 패널에서 저장 및 닫기를** 클릭합니다**.
...
2. 스프린트 보기의 **작업판** 탭에 있는 도구 모음의 오른쪽에 있는 보기 옵션** 기호(깔때기형 아이콘의 왼쪽에 직접)**를 선택하고 **보기 옵션** 드롭다운 목록에서 작업 세부 정보** 항목을 선택합니다**.** **  필터로 스프린트 2**를 선택합니다**.
...
3. **ToDo** 열 내에서 가장 최근 자습서**에 대한 작업 항목 **추가 페이지를 확인하고, 할당**되지 않은 항목을 클릭하고**, 사용자 계정 목록에서 계정을 선택하여 자신에게 작업을 할당합니다.
...
5. **스프린트** 보기의 용량** 탭에서 **+사용자** 추가를 클릭하고 **사용자 계정을 선택합니다. 이 사용자의 경우 작업** 필드를 개발 **** 로 **설정하고 **일**별 용량 텍스트 상자에 1**을 입력**합니다.
...
11. 스프린트 보기의 **작업판** 탭에 있는 도구 모음의 오른쪽에 있는 보기 옵션** 기호(깔때기형 아이콘의 왼쪽에 직접)를 선택하고 **보기 **옵션** 드롭다운 목록에서 할당 대상=** 항목을 선택합니다**.** ** 
...
2. 보드 패널에서 **보드 설정** 구성 코그 휠 아이콘(깔때기형 아이콘 오른쪽)을 클릭합니다**.**
...
4. 설정 패널의 **보드 설정** 구성(코그 휠)**** 에서 주석 탭을 **** 선택합니다.
...
7. EShop-WEB** 패널의 **보드** 탭에서 고객으로서를 **나타내는 작업 항목을 열고 새 자습서 백로그 항목을 보려고 합니다**.**
8. 자세한 항목 보기의 패널 맨 위에 있는 0개의** 메모 항목 오른쪽에 있는 **태그** 추가를 클릭합니다**.
9. 결과 텍스트 상자에 데이터를** 입력**하고 Enter** 키를 누릅니**다.
10. 이전 단계를 반복하여 ux** 태그를 추가합니다**.
11. 저장 및 닫기를 클릭하여 이러한 편집 내용을 **저장합니다**.
...
12. 보드 패널에서 **보드 설정** 구성 코그 휠 아이콘(깔때기형 아이콘 오른쪽)을 클릭합니다**.**
...
15. 설정** 패널에서 **열 탭을 **** 다시 선택합니다. 만든 QA 승인** 열 옆에 있는 **줄임표를 확인합니다. QA 승인된 열이 커밋**된 열과 **완료** 사이에 **배치되도록 오른쪽으로** 두 번 이동을 선택합니다**.
16. 설정** 패널에서 **저장**을 클릭합니다**.

17. ****이제 QA 승인된** 열이 Kanban 보드 보기에 표시되도록 **Boards 포털**을 새로 고칩니다**.
...
21. 보드 패널에서 **보드 설정** 구성 코그 휠 아이콘(깔때기형 아이콘 오른쪽)을 클릭합니다**.**
...
26. 보드 패널에서 **보드 설정** 구성 코그 휠 아이콘(깔때기형 아이콘 오른쪽)을 클릭합니다**.**
...
17. **쿼리>공개 쿼리** 보기에서 차트** 탭을 **선택하고 + 새 차트**를 클릭합니다**.
18. [차트** 구성] 패널**의 **[이름]** 텍스트 상자에 **[웹 작업] - [할당** 기준]** **드롭다운 목록에서 [할당 대상]**을 선택하고 **[차트** 저장]을 클릭하여 **변경 내용을 저장합니다.
...
19. 개요** 메뉴의 **대시보드** 섹션으로 **돌아갑니다. **EShop-Web** 섹션에서 이전에 사용한 제품 교육** 대시보드를 선택하여 **엽니다. 

20. 위쪽 메뉴에서 편집**을 클릭합니다**. 위젯** 추가 목록에서 차트**를 **검색하고 작업 항목**에 대한 차트를 선택합니다**.** 추가**를 클릭하여 **EShop-Web 대시보드에 이 위젯을 추가합니다. 

21. **작업 항목**에 대한 차트 내에서 **구성**(톱니바퀴)을 클릭하여 위젯 설정을 엽니다. 

22. 제목을 있는 그대로 적용합니다. 쿼리**에서 **공유 쿼리/웹 작업을** 선택합니다**. 차트 종류에 대해 원형**을 유지합니다**. 그룹화 기준**에서 **할당 대상을** 선택합니다**. 집계(개수) 및 정렬(값/오름차순) 기본값을 유지합니다. 

23. 저장을 클릭하여 구성을 확인합니다****. 

24. 쿼리 결과 원형 차트가 대시보드에 표시됩니다. **맨 위에 있는 편집** 완료 단추를 눌러 **변경 내용을 저장**합니다.
