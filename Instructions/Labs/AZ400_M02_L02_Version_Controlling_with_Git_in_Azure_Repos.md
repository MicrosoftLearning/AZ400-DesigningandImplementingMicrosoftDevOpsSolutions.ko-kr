...
2. **분기** 창의 **[마이닝**] 탭에서 마우스 포인터를 기본** 분기 항목 위로 **마우스 포인터를 가져가 오른쪽에 줄임표 기호(...)를 표시합니다.
3. 줄임표를 클릭하고 팝업 메뉴에서 **분기 정책**을 선택합니다.

    ![정책 설정](images/policy-settings.png)

4. **리포지토리 설정의 기본** 탭에서 최소 검토자** 수 필요 옵션을 **사용하지 않도록 설정합니다.
5. **리포지토리 설정의 기본** 탭에서 연결된 작업 항목** 확인 옵션을 **사용하지 않도록 설정합니다.

    ![분기 정책](images/branch-policies.png)

6. 이제 기본 분기에 대한 분기 정책을 사용하지 않도록 설정/제거했습니다.
