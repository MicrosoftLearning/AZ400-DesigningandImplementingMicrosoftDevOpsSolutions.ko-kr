...
> **참고**: 이 랩에서는 **packageForLinux** 매개 변수를 사용하면 안 되지만 Windows나 Linux에서는 해당 매개 변수를 사용할 수 있습니다.
    ...
    ```
13. yml-file에 업데이트를 저장하기 전에 보다 명확한 이름을 지정합니다. yaml-editor 창 위에 EShopOnweb/azure-pipelines-#.yml**이 표시됩니다**. (여기서 #은 숫자이며 일반적으로 1이지만 설정에서 다를 수 있습니다.) 해당 파일 이름을** 선택하고 **이름을 m09l16-pipeline.yml로 바꿉니다 **.**
